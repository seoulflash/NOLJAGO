...
<body>
	...
	<div class="container">
		<div class="write-box center-block">
			...
			<form action="boardWriterPro.do?pageNum=${pageNum }&id=${id}" method="post">
				...
				<table class="table">
					...
					<tr>
						...
						<td id="sub">
							<input type="text" class="form-control" name="subject" id="subject" maxlength="50" required="required">
						</td>
					</tr>
					<tr>
						<td colspan="2">
							<textarea class="content" name="content" id="content" rows="20" style="width: 100%;"></textarea>
						</td>
					</tr>
				</table>
				<div class="btn-box">
					<input type="submit"  class="btn btn-default input-sm" id="savebutton" value="글쓰기">
