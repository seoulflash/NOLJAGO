...
<div class="container-fluid">
	<div class="row" style="background-image: linear-gradient(to bottom, #dfe9f3 0%, white 100%);">
		<div id="top2" class="text-center">
			<h1  id="vr-title">VIRTUAL REALITY</h1>
		</div>
	</div>
			...
			<tr>
				<td rowspan="7" style="padding-bottom: 8px;">
					<a href="vrList1View.do?id=${id }&&cnum=${cafe.cnum }">
						<img src="images/${cafe.image1 }" alt="vr 가게" width="270" height="250"
							style="vertical-align: text-top"></a></td>
			</tr>
			<tr>
				<td><h4>
						<b><a href="vrList1View.do?id=${id }&&cnum=${cafe.cnum }"
							style="text-decoration: none;">${cafe.cname }</a></b>
					</h4></td>
			</tr>
			<tr>
				<td><c:choose>
					...
					</c:choose> 후기: ${cafe.review_count }개</td>
			</tr>
			<tr>
