...
<body>
	<nav class="navbar navbar-default">
		...
		<form action="vrWriteReviewPro.do?id=${id }&&cnum=${cnum}">
				<input type="hidden" name="id" value="${id }">
				<input type="hidden" name="cnum" value="${cnum }"><table style="text-align: center; border: 1px solid #dddddd;">
					<thead>
						<tr>
					...
					<tbody>
						<tr>
							<th>평가하기</th>
							<td>
								<button type="button" name="rate" onclick="btn1()" value="1" style="border: none; background-color: white; margin-left: 100px;"><img src="images/e_star.png" id="i1" width="25" height="30"></button>
								<button type="button" name="rate" onclick="btn2()" value="2" style="border: none; background-color: white;"><img src="images/e_star.png" id="i2" width="25" height="30"></button>
								<button type="button" name="rate" onclick="btn3()" value="3" style="border: none; background-color: white;"><img src="images/e_star.png" id="i3" width="25" height="30"></button>
								<button type="button" name="rate" onclick="btn4()" value="4" style="border: none; background-color: white;"><img src="images/e_star.png" id="i4" width="25" height="30"></button>
								<button type="button" name="rate" onclick="btn5()" value="5" style="border: none; background-color: white;"><img src="images/e_star.png" id="i5" width="25" height="30"></button>
							</td>
						</tr>
					</tbody>
					<tfoot>
